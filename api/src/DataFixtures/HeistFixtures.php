    ...
    public function load(ObjectManager $manager): void
    {
        foreach (self::DATA as $key => $heist) {
            ...
            $newHeist = (new Heist())
                ...
                ->setStartAt(\DateTime::createFromFormat('D M d Y H:i:s e+', $heist['startAt']))
                ->setShouldEndAt(\DateTime::createFromFormat('D M d Y H:i:s e+', $heist['shouldEndAt']))
                ->setEndedAt($endedAt ? \DateTime::createFromFormat('D M d Y H:i:s e+', $heist['endedAt']) : null)
