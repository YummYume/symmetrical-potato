...
create-vault: 
	docker run --rm -it -v $(PWD):/app -w /app/ansbible/group_vars/prod -e EDITOR=nano uhligit/ansible /bin/sh -c "apk add nano && ansible-vault create vault.yml && chmod a+rw"

edit-vault: 
	docker run --rm -it -v $(PWD):/app -w /app/ansbible/group_vars/prod -e EDITOR=nano uhligit/ansible /bin/sh -c "apk add nano && ansible-vault edit vault.yml && chmod a+rw"
